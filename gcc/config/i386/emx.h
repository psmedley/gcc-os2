...
#define __LIBGCC_INIT_SECTION_ASM_OP__ /* don't want ___DTOR_LIST__ */
...
#if 0 /* use definition in gas.h - new for GCC 9.1.0 */
...
extern void emx_eh_frame_section (const void*);
